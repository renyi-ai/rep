...
def main(hparams):    
    ...
    dataset = torchvision.datasets.CIFAR10(root=hparams.data_dir, train=False, download=True, transform=transform_val)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=hparams.batch_size, num_workers=4, pin_memory=True)
